...
Looking for a quick look-up on grammar, or wanna see the technical details? See our [reference](../reference.md) page.
...
### 2. [How to make a sentence](./2_sentences.md)
  Learn how to make basic sentences. We'll learn the usage of *li*, *e*, and *la*, how to form statements and questions, and introduce a few core words to play around with.
